<?php
//=========التوكن=========//
$token = "6483810642:AAEYYfjs6WtYYDFHIApF0Vb4iruV31QHQ40"; 
...
#############
$admin = "5632212005";
$Dev = array("$admin","5632212005");
$eri = array("$admin","5632212005");
$idbot = "6483810642";
$sudo = "$admin";
$buy = "Wa_geh";
$DevUser = "@$buy";
$devchink = "Ul_Il_lll";
$userbot = "wagohabang_bot";
$chsource = "$devchink";
############
if ($tc == 'private'){  
@$user = json_decode(file_get_contents("data/user.json"),true);
...
⋄︙ [تحديثات السورس الجديده](https://t.me/Ul_Il_lll)",
'parse_mode'=>"markdown",
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/Ul_Il_lll"]],
]])
]); 
}
}
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/Ul_Il_lll"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
...
########
if($text == "⋄ تجربة السورس"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"✵⁞ *اليك قائمة تجربة السورس*\n━━━━━━━━━━━━━\n⌯⁞ [كروب تجربة السورس](https://t.me/THBBS)\n⌯⁞ [قناة شروحات السورس](https://t.me/TH3SS)\n━━━━━━━━━━━━━\n⌯⁞ [مطور السورس](https://t.me/Wa_geh)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ كروب تجربة السورس ⁞⌯",'url'=>"t.me/thbbs"]],[['text'=>"⌯⁞ مطور السورس ⁞⌯",'url'=>"t.me/$buy"]],]])]);}}
#######
